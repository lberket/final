    ...
    return (
        <>
            ...
            <p className="article-text">
                ...
                US Center for disease control and Prevention (CDC), up to <a  className="link" href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7024093/" target={'_blank'}>70% of adolescents</a> sleep less
                than the recommended 8-10 hours on a given school day? Quite worrying, right? What’s more,
                short sleep at this age can <a  className="link" target={'_blank'} href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5812312/">increase the risk</a> for <strong>obesity, diabetes, injuries, poor mental
                ...
                for this could be an apparent <a  className="link" target={'_blank'} href="https://www.sciencedirect.com/science/article/abs/pii/B9780444538178000086?casa_token=Jt4m0C5W5-cAAAAA:-LR-Tw6COY7fWMDCbjCaw_ajfs-8kr3gVZcom6St0_0IQkxt9RFED4unhXiL4DEmpvrwWgx2Ek8">
                 ...
                 that the adolescent <a  className="link" target={'_blank'} href="https://journals.sagepub.com/doi/abs/10.1177/0748730404274265">circadian clock is less sensitive to light</a> during the morning when light 
                 usually advances the circadian clock and its timing of sleep. Finally, the homeostatic regulation of sleep, which increases sleep pressure with waking hours, <a  className="link" target={'_blank'} href="https://onlinelibrary.wiley.com/doi/abs/10.1111/j.1365-2869.2005.00467.x">could be altered in adolescents</a>, leading to delayed sleepy feeling.
            </p><p className="article-text">
                How does this shorter than optimal sleep affect adolescents’ academic performance?
                 <strong> Without enough sleep</strong>, numerous studies have shown that children can have <strong>problems</strong> with
                  <strong> attention, memory, problem-solving,</strong> and <a  className="link" target={'_blank'} href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4075951/">mood</a>. Poor sleep can also contribute to 
                  emotional issues and behavior problems. All of this can significantly affect the 
                  child’s academic performance and <a  className="link" target={'_blank'} href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4075951/">overall wellbeing</a>. One <a  className="link" target={'_blank'} href="https://www.nature.com/articles/s41539-019-0055-z">study</a> showed that better 
                  quality, longer duration, and greater consistency of <strong>sleep correlated with better
                   grades</strong>. Several <a  className="link" target={'_blank'} href="https://pubmed.ncbi.nlm.nih.gov/32316249/">other studies</a> suggested that students with poor sleep get worse 
                ...
                How can we help teens get better sleep and academic performance? One way which has been
                 ...
                 got on average <strong>34 min longer sleep duration</strong>, which was associated with a <a  className="link" target={'_blank'} href="https://www.science.org/doi/10.1126/sciadv.aau6200">4.5% increase</a> in
                ...
                rates and reduced tardiness showed significantly positive improvement with the later
                 ...
                 reported significantly higher <strong>depression</strong> symptoms, greater use of caffeine, and are
                  at greater risk for making poor choices for <strong>substance use</strong>. <a  className="link" target={'_blank'} href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7177233/#B107-ijerph-17-02574">Other positive effects</a>  of later school times confirmed by most studies which evaluated this were an

...
function A2() {
    ...
    return (
        <>
            ...
            <Image src={a2} className="ar-img" rounded />
            ...
            <p className="article-text">
                ...
                examine the association between <a className="link" target={'_blank'} href="https://www.nature.com/articles/s41467-021-22354-2">sleep duration and the incidence of
